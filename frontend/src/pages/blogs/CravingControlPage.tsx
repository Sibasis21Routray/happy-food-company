    ...
    <div className="min-h-screen bg-white pt-24">
      ...
      <div className="container mx-auto px-6 max-w-3xl pb-20">
        ...
        >
          ...
          <motion.h3 variants={paragraphVariants} className="text-lg font-light text-gray-800 mt-6 mb-3">Energy Bars: A Quick Boost</motion.h3>
          ...
          <motion.h3 variants={paragraphVariants} className="text-lg font-light text-gray-800 mt-6 mb-3">The Power of Protein</motion.h3>
          ...
          <motion.h3 variants={paragraphVariants} className="text-lg font-light text-gray-800 mt-6 mb-3">Satiety and Portion Control</motion.h3>
          <ul className="space-y-2 mb-6 ml-4">
            {[
          ...
          <motion.h3 variants={paragraphVariants} className="text-lg font-light text-gray-800 mt-6 mb-3">The Reduced-Calorie Edge</motion.h3>
          <motion.p variants={paragraphVariants} className="text-gray-600 text-base leading-relaxed mb-6">
          ...
          <motion.h3 variants={paragraphVariants} className="text-lg font-light text-gray-800 mt-6 mb-3">A Smart Snack Choice</motion.h3>
          <motion.p variants={paragraphVariants} className="text-gray-600 text-base leading-relaxed mb-6">
