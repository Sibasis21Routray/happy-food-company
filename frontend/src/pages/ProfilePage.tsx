...
//   Navigation, Trash2, ShoppingCart, Menu, X, UserCircle, Settings
// } from 'lucide-react';
...
//       }}
//       className={`w-full flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 transition-all ${
...
//           {icon}
//         </span>
//         <span className={`text-[12px] sm:text-[14px] font-bold tracking-tight uppercase ${activeSection === id ? 'font-black' : ''}`}>
//           {label}
//         </span>
//       </div>
...
//     <div className="flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100">
//       <span className="text-[#FA6011]">{icon}</span>
//       <span className="text-[11px] sm:text-[14px] font-black text-gray-400 tracking-wider uppercase">{label}</span>
...
//   return (
//     <ErrorBoundary>
//       <div className="min-h-screen pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-12 sm:pb-16 md:pb-20 bg-[#f1f3f6]">
//         <div className="container mx-auto px-3 sm:px-4 max-w-6xl">
          
//           {/* Mobile Menu Toggle Button - Different from navbar */}
//           <div className="md:hidden mb-4">
//             <button
//               onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
//               className="w-full bg-gradient-to-r from-[#FA6011] to-[#f87a2f] p-4 rounded-xl shadow-lg flex items-center justify-between active:scale-[0.98] transition-all"
//             >
...
//                   className="fixed md:relative inset-0 md:inset-auto z-50 md:z-auto w-[280px] md:w-[300px] bg-white md:bg-transparent shadow-xl md:shadow-none overflow-y-auto md:overflow-visible rounded-r-2xl md:rounded-none"
//                 >
//                   {/* Mobile Sidebar Header */}
//                   <div className="md:hidden bg-gradient-to-r from-[#FA6011] to-[#f87a2f] p-5 flex items-center justify-between">
//                     <div className="flex items-center gap-3">
...
//                     <SidebarItem id="orders" label="MY ORDERS" icon={<Package size={18} />} groupEnd />
                    
//                     <GroupHeader label="ACCOUNT SETTINGS" icon={<User size={18} />} />
//                     <SidebarItem id="profile" label="Profile Information" icon={<UserCheck size={16} />} />
//                     <SidebarItem id="addresses" label="Manage Addresses" icon={<MapPin size={16} />} />
//                     <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-100 text-[12px] sm:text-[14px] font-bold text-gray-500 uppercase cursor-pointer hover:bg-gray-50">
...
//                     <GroupHeader label="MY STUFF" icon={<Package size={18} />} />
//                     <SidebarItem id="wishlist" label="My Wishlist" icon={<Heart size={16} />} />
//                     <SidebarItem id="coupons" label="My Coupons" icon={<Ticket size={16} />} />
//                     <SidebarItem id="notifications" label="All Notifications" icon={<Bell size={16} />} />
//                     <SidebarItem id="gift-cards" label="Gift Cards" icon={<Gift size={16} />} />
//                   </div>
...
//                     }}
//                     className="mt-2 w-full bg-white p-4 text-left font-black text-gray-600 shadow-sm border border-gray-200/50 rounded-sm hover:bg-gray-50 flex items-center gap-4"
//                   >
//                     <User size={18} className="text-[#FA6011]" />
//                     LOGOUT
//                   </button>
//                 </motion.div>
//               )}
...
//             {/* Main Content Area */}
//             <div className="flex-1 bg-white shadow-sm border border-gray-200/50 p-4 sm:p-6 md:p-8 rounded-sm overflow-hidden min-h-[500px] sm:min-h-[600px]">
//               <AnimatePresence mode="wait">
//                 {activeSection === 'profile' && (
//                   <motion.div 
//                     key="profile" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8 sm:space-y-12"
//                   >
...
//                               }`}>
//                                 {formData.gender === g && <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-[#FA6011]" />}
//                               </div>
...
//                   <motion.div key="addresses" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6 sm:space-y-10">
...
//                                   <div className={`w-4 h-4 sm:w-6 sm:h-6 rounded-full border-2 flex items-center justify-center transition-all ${addressForm.type === t ? 'border-[#F95F11]' : 'border-gray-200'}`}>
...
//                         <div key={addr._id || i} className="p-4 sm:p-6 md:p-8 bg-white border border-gray-100 rounded-2xl sm:rounded-3xl relative group hover:border-[#F95F11]/30 transition-all shadow-sm">
//                           <div className="flex items-center justify-between mb-3 sm:mb-6">
//                             <span className="px-2 sm:px-3 py-1 sm:py-1.5 bg-[#F95F11]/5 text-[#F95F11] text-[8px] sm:text-[10px] font-black rounded-lg uppercase tracking-widest border border-[#F95F11]/10">
//                               {addr.type}
//                             </span>
//                           </div>
...
//                   <motion.div key="wishlist" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-6 sm:space-y-10">
//                     <div className="flex items-center justify-between flex-wrap gap-2">
//                       <h2 className="text-base sm:text-lg font-black text-gray-900 uppercase">My Wishlist ({wishlistItems.length})</h2>
//                     </div>
...
//                           <div key={item._id} className="bg-white border border-gray-100 rounded-2xl sm:rounded-3xl p-3 sm:p-4 relative group hover:shadow-xl transition-all h-full flex flex-col">
//                             <button 
//                               onClick={() => handleRemoveFromWishlist(item._id)}
//                               className="absolute top-3 sm:top-6 right-3 sm:right-6 p-1.5 sm:p-2 bg-gray-50 rounded-full text-gray-300 hover:text-red-500 hover:bg-red-50 transition-all z-10"
//                             >
//                               <Trash2 size={14} />
//                             </button>
                            
//                             <div className="cursor-pointer flex-1" onClick={() => navigate(`/product/${item.slug || item._id}`)}>
//                               <div className="aspect-[1/1] bg-gray-100 rounded-xl sm:rounded-2xl overflow-hidden mb-3 sm:mb-4 border border-gray-100">
//                                 <img src={item.images?.[0] || '/images/avatar-placeholder.png'} alt={item.title || 'Product'} 
...
//                               className="w-full bg-[#FA6011] text-white font-black py-2.5 sm:py-3 rounded-xl shadow-lg shadow-orange-100 flex items-center justify-center gap-1.5 tracking-widest text-[10px] sm:text-[12px] uppercase group-hover:brightness-110 transition-all">
  ...
  const SidebarItem = ({ id, label, icon }: { id: Section; label: string; icon: React.ReactNode }) => (
    <button 
      ...
      className={`w-full flex items-center justify-between px-4 py-3 transition-all ${
        activeSection === id ? 'bg-gray-50 text-gray-900' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700'
      }`}
    >
      <div className="flex items-center gap-3">
    ...
    <ErrorBoundary>
      <div className="min-h-screen pt-24 pb-16 bg-gray-50">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-light text-gray-800">My Account</h1>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <AnimatePresence>
              {(mobileMenuOpen || windowWidth >= 768) && (
                <motion.div 
                  ...
                  exit={{ x: -300, opacity: 0 }}
                  transition={{ duration: 0.3 }}
                  className="fixed md:relative inset-0 md:inset-auto z-50 md:z-auto w-[280px] md:w-72 bg-white md:bg-transparent shadow-xl md:shadow-none overflow-y-auto md:overflow-visible"
                >
                  {/* Mobile Sidebar Header */}
                  <div className="md:hidden bg-gray-800 p-5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                  ...
                  {/* Desktop User Info */}
                  <div className="hidden md:block bg-white border border-gray-100 p-5 mb-4">
                    <div className="flex items-center gap-3">
                  ...
                  <div className="bg-white border border-gray-100">
                    <SidebarItem id="profile" label="Profile" icon={<User size={16} />} />
                    <SidebarItem id="orders" label="Orders" icon={<Package size={16} />} />
                    <SidebarItem id="addresses" label="Addresses" icon={<MapPin size={16} />} />
                    <SidebarItem id="wishlist" label="Wishlist" icon={<Heart size={16} />} />
                    <SidebarItem id="coupons" label="Coupons" icon={<Ticket size={16} />} />
                    <SidebarItem id="notifications" label="Notifications" icon={<Bell size={16} />} />
                  </div>
            ...
            {/* Main Content */}
            <div className="flex-1 bg-white border border-gray-100 p-6 md:p-8 min-h-[500px]">
              <AnimatePresence mode="wait">
                {/* Profile Section */}
                {activeSection === 'profile' && (
                  <motion.div 
                  ...
                  >
                    <div>
                      <h2 className="text-lg font-light text-gray-800 mb-1">Personal Information</h2>
                        ...
                        {['Male', 'Female'].map((g) => (
                          <label key={g} className="flex items-center gap-2 cursor-pointer">
                            <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                              formData.gender === g ? 'border-gray-600' : 'border-gray-300'
                            }`}>
                              {formData.gender === g && <div className="w-2 h-2 rounded-full bg-gray-600" />}
                            </div>
                            <input type="radio" className="hidden" disabled={!editFields.personal} name="gender" value={g}
                              checked={formData.gender === g} onChange={(e) => setFormData({ ...formData, gender: e.target.value })} />
                ...
                {activeSection === 'orders' && (
                  ...
                  >
                    <div className="mb-6">
                      <h2 className="text-lg font-light text-gray-800 mb-1">My Orders</h2>
                      <div className="w-12 h-px bg-gray-200" />
                    </div>
                ...
                {activeSection === 'addresses' && (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <div>
                        <h2 className="text-lg font-light text-gray-800 mb-1">Saved Addresses</h2>
                        <div className="w-12 h-px bg-gray-200" />
                      </div>
                      {!isAddingAddress && (
                        <button 
                            ...
                            {(['Home', 'Work'] as const).map((t) => (
                              <label key={t} className="flex items-center gap-2 cursor-pointer">
                                <div className={`w-3.5 h-3.5 rounded-full border flex items-center justify-center ${
                                  addressForm.type === t ? 'border-gray-600' : 'border-gray-300'
                                }`}>
                                  {addressForm.type === t && <div className="w-2 h-2 rounded-full bg-gray-600" />}
                                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {savedAddresses.map((addr, i) => (
                        <div key={addr._id || i} className="border border-gray-100 p-4 hover:border-gray-200 transition-all">
                          <div className="flex justify-between items-start mb-2">
                            <span className="text-[10px] text-gray-400 uppercase bg-gray-50 px-2 py-0.5">
                              {addr.type}
                            </span>
                          </div>
                ...
                {activeSection === 'wishlist' && (
                  ...
                  >
                    <div className="mb-6">
                      <h2 className="text-lg font-light text-gray-800 mb-1">My Wishlist ({wishlistItems.length})</h2>
                      <div className="w-12 h-px bg-gray-200" />
                    </div>
                    ...
                    {loadingWishlist ? (
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {wishlistItems.map((item) => (
                          <div key={item._id} className="border border-gray-100 p-4 hover:border-gray-200 transition-all group relative">
                            <button 
                              onClick={() => handleRemoveFromWishlist(item._id)}
