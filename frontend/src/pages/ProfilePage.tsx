  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (formData.password && formData.password.length > 0) {
        Object.assign(updatedData, { password: formData.password });
      }
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input 
                          ...
                          className="w-full px-4 py-3 border border-gray-100 bg-gray-50 cursor-not-allowed text-gray-700 text-base rounded-sm"
                        />
                      </div>
                      ...
                      <div className="flex gap-8">
                        {['Male', 'Female'].map((g) => (
                          <label key={g} className="flex items-center gap-2 cursor-pointer">
                            ...
                            <input type="radio" className="hidden" disabled={!isEditing} name="gender" value={g}
                              checked={formData.gender === g} onChange={(e) => setFormData({ ...formData, gender: e.target.value })} />
                            <span className={`text-base ${isEditing ? 'text-gray-800' : 'text-gray-500'}`}>{g}</span>
                          </label>
                        ))}
                      </div>
                    </div>

                    {/* Email and Mobile side-by-side - BOTH EDITABLE */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm text-gray-700 font-semibold tracking-tight mb-2">
                          Email Address
                        </label>
                        <input
                          type="email"
                          ...
                          className={`w-full px-4 py-3 border text-sm transition-all duration-200 rounded-md ${
                            isEditing
                              ? 'border-gray-300 focus:border-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-700 bg-white'
                              : 'border-gray-100 bg-gray-50/70 text-gray-500 cursor-not-allowed select-none'
                          }`}
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 border text-sm transition-all duration-200 rounded-md ${
                            isEditing
                              ? mobileError
                                ? 'border-red-500 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500 bg-white'
                                : 'border-gray-300 focus:border-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-700 bg-white'
                              : 'border-gray-100 bg-gray-50/70 text-gray-500 cursor-not-allowed select-none'
                          }`}
                        />
                    ...
                    <div className="w-full md:w-1/2">
                      <div className="flex justify-between items-center mb-2">
                        <label className="block text-sm text-gray-700 font-semibold tracking-tight">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border border-gray-300 bg-white text-gray-900 text-sm transition-all duration-200 rounded-md shadow-sm focus:border-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-700 placeholder:text-gray-400"
                      />
